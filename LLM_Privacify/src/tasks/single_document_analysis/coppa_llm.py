...
with COPPA regulations and restrictions.
"""
map_prompt = PromptTemplate.from_template(map_template)
map_chain = LLMChain(llm=llm, prompt=map_prompt)

# Reduce
reduce_template = """The following is a list of inconsistencies between a privacy policy and what is restricted by COPPA: \n\n{docs}
...
# Result Chain
coppa_summarizer_chain = MapReduceDocumentsChain(
...
response_schemas = [
    ResponseSchema(name="inconsistencies", description="A JSON list of 20 unique items or less composed of inconsistencies between the privacy policy and COPPA regulations."),
]
...
Here is a summary of COPPA inconsistencies found in a privacy policy:\n\n{summary}\n\nPlease strictly adhere to the following format instructions. {format_instructions}. 

Please return a formatted summary of the COPPA inconsistencies found in the privacy policy.""",
