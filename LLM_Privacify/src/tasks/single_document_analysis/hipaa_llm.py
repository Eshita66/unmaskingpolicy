...
with HIPAA regulations and restrictions.
"""
map_prompt = PromptTemplate.from_template(map_template)
map_chain = LLMChain(llm=llm, prompt=map_prompt)

# Reduce
reduce_template = """The following is a list of inconsistencies between a privacy policy and what is restricted by HIPAA: \n\n{docs}
...
# Result Chain
hipaa_summarizer_chain = MapReduceDocumentsChain(
...
response_schemas = [
    ResponseSchema(name="inconsistencies", description="A JSON list of 20 unique items or less composed of inconsistencies between the privacy policy and HIPAA regulations."),
]
...
Here is a summary of HIPAA inconsistencies found in a privacy policy:\n\n{summary}\n\nPlease strictly adhere to the following format instructions. {format_instructions}. 

Please return a formatted summary of the HIPAA inconsistencies found in the privacy policy.""",
